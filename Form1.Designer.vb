...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' a4wMenuStrip
        ' 
        a4wMenuStrip.Items.AddRange(New ToolStripItem() {tsmSTART, tsmEDIT, tsmFORMAT, tsmOBJECT})
        a4wMenuStrip.Location = New Point(0, 0)
        a4wMenuStrip.Name = "a4wMenuStrip"
        a4wMenuStrip.Size = New Size(820, 25)
        a4wMenuStrip.TabIndex = 1
        a4wMenuStrip.Text = "MenuStrip1"
        ' 
        ' tsmSTART
        ' 
        ...
        tsmFORMAT.DropDownItems.AddRange(New ToolStripItem() {tsmiFont, tsmiFColor, tsmiBColor, tsmiA4BColor, tsmiCap, tsmiLow, tssAlignL, tsmiAlignL, tsmiAlignC, tsmiAlignR, tsmiAlignJ, tssSpacing, tsmiSpaceBetween, tsmiSpecial})
        ...
        MainMenuStrip = a4wMenuStrip
        Name = "Form1"
        Text = "EE A4W Portrait [RTF]"
        pARK.ResumeLayout(False)
        a4wMenuStrip.ResumeLayout(False)
        a4wMenuStrip.PerformLayout()
    ...
    Friend WithEvents a4wMenuStrip As MenuStrip
