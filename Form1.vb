...
Public Class Form1 'Ver 1.0
    ...
    Private Function FindBulletListStart(rtb As RichTextBox, position As Integer) As Integer 'Copilot: Säkrar början på punktlistan.
        While position > 0
    ...
    Private Function FindBulletListEnd(rtb As RichTextBox, position As Integer) As Integer 'Copilot: Säkrar slutet på punktlistan.
