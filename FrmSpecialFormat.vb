...
Public Class FrmSpecialFormat
    ...
    Private Sub BtnAPPLY_Click(sender As Object, e As EventArgs) Handles btnAPPLY.Click
        Select Case True
            ...
            Case rbBULLET.Checked
                ApplyControlWord("\bullet")
            Case rbSHAD.Checked
    ...
    Private Sub ApplyControlWord(controlWord As String) 'Copilot: Formaterar med ett valfritt kontrollord i markerad text. Tom sträng nollställer.
        ...
        If length > 0 Then
            ...
            Dim regexUnderline As New RegularExpressions.Regex("\\bullet|\\embo|\\impr|\\scaps|\\shad|\\sub|\\super|\\ul(thdashdd|thdashd|thldash|thdash|dashdd|dashd|ldash|dash|uldbwave|hwave|wave|thd|th|db|d|w)")
